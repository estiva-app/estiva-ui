...
describe('tokens.css against tailwind-preset.js', () => {
  ...
  it('names at least the bg, text, border, accent, semantic and shadow families', () => {
    ...
    expect(wanted.length).toBe(44) // 8 bg + 6 text (text-interactive joined 2026-09-01, with Toast) + 4 border + 3 accent + 8 semantic + 3 shadow + focus-ring + 11 transparent colours (D16, 2026-09-06)
  })
