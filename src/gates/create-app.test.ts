...
describe('create-estiva-app', () => {
  ...
  it('starts the count at zero and keeps the CI job named gate', () => {
    ...
    expect(Object.values(count.rules)).toEqual([{ errors: 0, warnings: 0, escapes: 0 }, { errors: 0, warnings: 0, escapes: 0 }, { errors: 0, warnings: 0, escapes: 0 }, { errors: 0, warnings: 0, escapes: 0 }])
