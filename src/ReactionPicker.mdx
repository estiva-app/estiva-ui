...
- **Offering a reaction**, from a card's quick menu or a message's hover
  controls. This is the case it exists for, and the only one.

<Canvas of={ReactionPickerStories.FromAQuickMenu} />
