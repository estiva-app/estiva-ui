...
**Words:** the label is a verb phrase, sentence case — "Create issue",
"Save changes". A destructive label names its object — "Delete project",
never a bare "Delete".
...
*Provenance: Peek's Button, verbatim (2026-08-28); Ship added `destructive`
and the `type="button"` default.*
