...
- The rail pairs with the **floating TopBar**: the burger in the bar's
  `menu` slot collapses it, the app's mark rides in `brand` beside the
  burger. Collapsing is the caller's — the rail only gets given less room
  (or none) to stand in.
