...
- A dialog's title → **DialogShell**, which draws this bar with the dialog's own 18px title.

- A row you draw yourself at the top of a column — your own padding and a line
  under it → this part. Its numbers are every column's. The lint refuses the
  hand-made row (`estiva/no-handmade-header`).
