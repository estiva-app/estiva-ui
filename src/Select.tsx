    ...
    <>
      <button
        ...
        className={cn(
          ...
          'focus-visible:border-border-strong aria-expanded:border-border-strong',
          'signal:transition-shadow signal:focus-visible:border-border-focus signal:focus-visible:shadow-[shadow:var(--focus-ring)]',
